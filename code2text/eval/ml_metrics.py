...
docstrings, codes, logic_scores, step2_scores = load_data(file_path)
...
# %%
train_texts, train_labels = code_doc_pairs, logic_scores
...
training_args = TrainingArguments(
    report_to="wandb",
    run_name="ml-annotator" + time_stamp,
    output_dir="./results" + time_stamp,  # output directory
