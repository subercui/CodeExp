...
#
# File inherited from
# https://github.com/huggingface/transformers/tree/05fa1a7/examples/pytorch/summarization
#
...
Usage:
python finetune-codeT5.py \
    --model_name_or_path Salesforce/codet5-base \
    --do_train \
    --do_eval \
    --text_column code \
    --summary_column docstring \
    --train_file data/GithubCodeDocStep1n2Filtered.train.jsonl \
...
python -m torch.distributed.launch \
    --nproc_per_node 1 finetune-codeT5.py \
    --model_name_or_path Salesforce/codet5-base \
    --do_train \
    --do_eval \
    --text_column code \
        ...
        if (
            ...
            if self.train_file is not None:
                ...
                assert extension in [
                    ...
                    "json",
                    "jsonl",
                ], "`train_file` should be a csv or a json(l) file."
            if self.validation_file is not None:
                ...
                assert extension in [
                    ...
                    "json",
                    "jsonl",
                ], "`validation_file` should be a csv or a json(l) file."
...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        # load_dataset use extension json for jsonlines files
    ...
    # tokenizer.model_max_length = data_args.max_source_length
