...
step1_model_path = (
    "/home/v-haotiancui/NL2Code/Copilot-2/code2text/eval/"
    "results20220118-061900/checkpoint-700"
)
step2_model_path = (
    "/home/v-haotiancui/NL2Code/Copilot-2/code2text/eval/"
    "results_step220220118-072033/checkpoint-2400"
)
...
# %% load
codes, docstrings = load_code_doc(step1_file)
...
with open(output_file, "w") as f:
    for doc, code, step1_score, step2_cate in zip(
        docstrings, codes, step1_scores, step2_cates
    ):
        d = {
            "docstring": doc,
            "code": code,
